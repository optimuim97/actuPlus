...
@section('content')
    <div class="card card-primary">
        <div class="card-header"><h4>Creer son compte Admin</h4></div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="first_name">Nom Complet:</label><span
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="email" type="email"
                                   ...
                                   placeholder="" name="email" tabindex="1"
                                   value="{{ old('email') }}"
                                   required autofocus>
                            <div class="invalid-feedback">
                                {{ $errors->first('email') }}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="password_confirmation"
                                   class="control-label">Confirmation :</label><span
                                    class="text-danger">*</span>
